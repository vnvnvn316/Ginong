...
const submitSection = document.querySelector(".h-value")
const changeBtn = locationSection.querySelector(".n-btn");

    //변경버튼을 클릭했을 때 location-pop.html 자식창 띄우기
    changeBtn.onclick = function (){

        const selectedId = submitSection.querySelector(".location-id").value;
        const popup = window.open("/location-pop", "_blank", "width=600,height=300, top=250,left=100");
